"""Ustawienia bazowe wspolne dla wszystkich srodowisk."""
...
# Wczytaj .env jesli istnieje (lokalnie). W Dockerze zmienne wstrzykuje compose.
...
SPECTACULAR_SETTINGS = {
    "TITLE": "System zarzadzania finansami osobistymi API",
    "DESCRIPTION": "REST API: transakcje, kategorie, budzety, raporty, analiza AI.",
    "VERSION": "1.0.0",
